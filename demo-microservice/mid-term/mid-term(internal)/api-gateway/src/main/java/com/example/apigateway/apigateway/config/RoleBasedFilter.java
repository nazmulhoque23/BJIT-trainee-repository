...
//    private static final String BASE_PATH = "/api";
    ...
    public GatewayFilter apply(Config config) {
        List<String> configRoles = config.getRequiredRoles();
...
//            }
            if(hasRequiredRoles(roles, configRoles)){
                return chain.filter(exchange);
            }
            else{
    ...
    public boolean hasRequiredRoles(List<String> roles, List<String> configRoles){
